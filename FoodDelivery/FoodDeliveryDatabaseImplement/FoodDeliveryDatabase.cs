...
namespace FoodDeliveryDatabaseImplement
{
    public class FoodDeliveryDatabase : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=FoodDeliveryDatabase3;Integrated Security=True;MultipleActiveResultSets=True;");
            }
